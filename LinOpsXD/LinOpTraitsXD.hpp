...
template<typename L, typename R, typename OP>
struct is_negation_expr<LinOpExprXD<L,R,OP>>: public std::is_base_of<OperatorNegation_t, std::remove_reference_t<OP>>
{};
...
template<typename L, typename R, typename OP>
struct is_subtraction_expr<LinOpExprXD<L,R,OP>>: public std::is_base_of<OperatorSubtraction_t, std::remove_reference_t<OP>>
{};
